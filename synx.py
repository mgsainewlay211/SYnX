...
def banner():
    ...
    print("\033[1;36m          KURANOMI - Project SYnX \033[0m")
...
def show_menu():
    ...
    print("  \033[1;32m[1]\033[0m 🎮 Gaming Mode ")
    print("  \033[1;34m[2]\033[0m 🛡️ Stable Mode  ")
    print("  \033[1;36m[3]\033[0m ⭐ Super Stable (Recommended for daily use) ")
    print("  \033[1;31m[4]\033[0m 🔄 Change WiFi Settings")
...
def get_user_inputs():
    ...
    print("="*56)
    print("\033[1;36m[!] Please enter your WiFi details below:\033[0m\n")
    ...
    if not mac_address:
        print("\033[1;31m[-] MAC Address is required!\033[0m")
    ...
    if not gateway_ip:
        print("\033[1;31m[-] Gateway IP is required!\033[0m")
        return None, None, None
...
def start_bypass(mode="gaming"):
    ...
    print("\n\033[1;33m[*] Internet Bypass စတင်နေပါပြီ..(bypass l ပြလည်းpingပေါ်ရင်လိုင်းရပါတယ်\033[0m")
...
def main():
    ...
    while True:
        ...
        choice = input("\n\033[1;32m=> Select option (1-5): \033[0m").strip()
        ...
        if choice == "1":
            ...
            print("\033[1;31m[-] မှားယွင်းနေပါသည်။ 1-5 အတွင်းသာ ရွေးပေးပါ။\033[0m")
            time.sleep(1)
